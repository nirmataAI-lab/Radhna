...
import type { 
  OrderStatus, LoginResponse, DashboardStats, Category, ProductionStock, 
  FoodItem, OrderItem, Order, AnalyticsData, Coupon 
} from 'shared-types';
...
// Shadow fetch inside this module so all API calls get auto-refresh on 401.
