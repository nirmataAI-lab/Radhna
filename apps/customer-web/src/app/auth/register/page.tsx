...
import { registerApi, useAuthStore } from '../../../lib/store/authStore';
import { UserPlus, Utensils, AlertCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 text-slate-100">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-slate-400">
          Join Radhna Cuisine for fast online ordering & tracking
        </p>
      </div>
        ...
        <div className="bg-slate-900 border border-slate-800 py-8 px-6 shadow-xl rounded-2xl sm:px-10">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 px-4 bg-amber-500 hover:bg-amber-600 font-semibold text-slate-950 rounded-xl transition shadow-lg shadow-amber-500/20 flex items-center justify-center gap-2 text-sm disabled:opacity-50"
            >
              {loading ? (
